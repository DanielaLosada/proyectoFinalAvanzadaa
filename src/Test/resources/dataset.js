...
db.cuentas.insertMany([
    {
        _id: ObjectId("66f8dbbb4b350424b236bddc"),
        ...
        password: "$2a$10$3dfgFw4DcfwPyfVpzf/wcHH11y/SO.JKTv9szjjfNWXckkCkCsp", // Contraseña sin encriptar: passwordJosePerez
        status: "INACTIVE",
        user: {
            _id: "1005774027",
            name: "Jose Perez",
            phoneNumber: "3201234567",
            address: "Cll 50 # 10-20"
        },
        _class: "co.edu.uniquindio.proyecto.model.Accounts.Account"
    },
    {
        _id: ObjectId("66f8dbfb12c88b4846e60861"),
        ...
        rol: "CUSTOMER",
        registrationDate: new Date(),
        password: "$2a$10$f5Wshk1fbtA9X.lP5qDg/AJGnJLKyt5zpVDFnkJFQspqvOklzLpzL", // Contraseña sin encriptar: passwordDianaLopez
        status: "INACTIVE",
        user: {
            _id: "1005774028",
            name: "Diana Lopez",
            phoneNumber: "3137896543",
            address: "Crr 25 # 8-15"
        },
        _class: "co.edu.uniquindio.proyecto.model.Accounts.Account"
    },
    {
        _id: ObjectId("66f8dc576f736842f97ca0cf"),
        ...
        rol: "CUSTOMER",
        registrationDate: new Date(),
        password: "$2a$10$VbcWcWcxGbcHKhZd2DvsfsfMktZ9yuZNQjzfXGG2hfyGkt2fvV2NQ", // Contraseña sin encriptar: passwordJuanAlvarez
        status: "INACTIVE",
        user: {
            _id: "1005774029",
            name: "Juan Alvarez",
            phoneNumber: "3121239876",
            address: "Av 12 # 4-32"
        },
        _class: "co.edu.uniquindio.proyecto.model.Accounts.Account"
    },
    {
        _id: ObjectId("66f8dc7f8d4a5579f3e388d4"),
        ...
        rol: "ADMINISTRATOR",
        registrationDate: new Date(),
        password: "$2a$10$scuNykLKSOaMytKlFYzTXF.asKfKnJY29fqspGKlcK8QkslxsFwP2", // Contraseña sin encriptar: passwordMariaGutierrez
        status: "INACTIVE",
        user: {
            _id: "1005774030",
            name: "Maria Gutierrez",
            phoneNumber: "3104567890",
            address: "Cll 60 # 15-10"
        },
        _class: "co.edu.uniquindio.proyecto.model.Accounts.Account"
    }
]);
